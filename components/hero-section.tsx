  ...
  return (
    <div className={cn('relative', className)} {...props}>
      ...
      <div className="relative">
        ...
        //   initial="initial"
        //   animate="animate"
          className="mt-48 text-center text-4xl font-bold leading-tight tracking-tight lg:text-[64px]"
        >
          Scripting Success,
          <span className="block" /> Connecting writers and producers
        </h2>
        <p className="mt-8 text-center text-lg w-full px-8 md:w-[40rem] m-auto leading-tight tracking-tight">Dive into a world of creativity and innovation, where you&apos;ll find a diverse selection of scripts for every genre, style, and format.</p>
        ...
        >
          ...
          >
            ...
            {/* <span className="bg-black text-white -mr-2.5 ml-2.5 rounded-full px-2 py-1.5 text-xs">
              Free Now
            </span> */}
          </Button>
